                    ...
                    case "/start" -> {
                        execute(SendMessage.builder()
                                .text("""
                                        ...
                                        Введите комманду /help (ну или тыкните на ссылку), чтобы вывести информацию о поддерживаемых коммандах.
                                        Ты также можешь добавить свой город в базу! Перейди на сайт https://botinfocity.herokuapp.com/ и заполни форму :)
                                        Иногда Heroku сбоит и сайт ложится, подождите минуту-две и повторите попытку зайти на сайт.""")
